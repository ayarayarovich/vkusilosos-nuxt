<template>
  <div class="relative">
    <input
      :id="inputID"
      v-model="value"
      class="peer w-full select-none rounded-xl border-2 border-transparent bg-white pb-3 pl-4 pr-14 pt-7 text-base placeholder-transparent shadow-main outline-none transition-colors focus:border-orange-200"
      :class="{
